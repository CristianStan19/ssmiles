...
public class ReceptionistDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavigationView navigationView = findViewById(R.id.nav_view_rec);
        ...
        if (savedInstanceState == null) {
            replaceFragment(new ReceptionistAppointmentsFragment());
            navigationView.setCheckedItem(R.id.Appointments_Rec); // Select Schedule by default
        }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
         if (menuItem.getItemId() == R.id.Appointments_Rec)
        {
            replaceFragment(new ReceptionistAppointmentsFragment());
        }
        else if (menuItem.getItemId() == R.id.Logout_Rec)
        {
            Toast.makeText(getApplicationContext(), R.string.logout, Toast.LENGTH_SHORT).show();
            FirebaseAuth.getInstance().signOut();
            Intent intent = new Intent(getApplicationContext(), LogIn.class);
